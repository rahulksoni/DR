function [c,ceq] = DR_SQP_Constraints(x)
...
Common_equalities = [x(1)-x(6);  % solid flow rate balancing
    ...
    x(15)+x(16)-x(6)*(1/x(31)-1)+x(17);
    x(7)*(1/x(32)-1)+x(2)*(1/x(34)-1)-x(9)*(1/x(35)-1);
    x(9)*(1/x(35)-1)+x(3)*(1/x(36)-1)+x(20)-x(10)*(1/x(37)-1)-x(26);
    x(2)*(1/x(34)-1)+x(3)*(1/x(36)-1)-x(10)*(1/x(37)-1)+x(12)*(1/x(39)-1)-x(29);
    x(19)-x(8)*(1/x(33)-1)-x(12)*(1/x(39)-1)-x(24)+x(5)*(1/x(40)-1);
    x(26)+x(21)-x(27);
    x(16)+x(18)-x(23)+x(30); 
    (x(28)-x(17))+x(22)-x(23);
    x(11)*(1/x(38)-1)-x(29)+x(25);
    ...
    % x(15)+x(22)+x(20)+x(21)+x(24)+x(25)-x(5)*(1/x(40)-1)-x(30);

    % Additional supporting constraints
    x(34)-x(36)];

%% Vanadium species balance
V_equalities = [x(1)*x(41)+x(16)*x(55)-x(6)*x(46)-x(6)*(1/x(31)-1)*x(56)+x(17)*x(57);
    ...
    x(75)*x(77)+x(75)*((1/x(76))-1)*x(78)-x(7)*x(47)-x(7)*((1/x(32)-1))*x(60)-x(8)*x(48)-x(8)*((1/x(33)-1))*x(61);
    ...
    (x(28)-x(17))*x(57)-x(23)*x(71);    
    x(16)*x(55)+x(18)*x(58)-x(23)*x(71);   
    x(2)*x(42)+x(2)*(1/x(34)-1)*x(62)+x(3)*x(43)+x(3)*(1/x(36)-1)*x(64)-x(10)*x(50)-x(10)*(1/x(37)-1)*x(65)+x(12)*x(52)+x(12)*(1/x(39)-1)*x(72)-x(29)*x(74)+x(4)*x(44);    
    x(19)*x(59)-x(8)*x(48)-x(8)*(1/x(33)-1)*x(61)-x(12)*x(52)-x(12)*(1/x(39)-1)*x(72)+x(5)*x(45)+x(5)*(1/x(40)-1)*x(73);    
